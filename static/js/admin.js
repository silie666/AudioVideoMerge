                ...
                $(this).validate({
                    ...
                    highlight: function (element, errorClass, validClass) {
                        if (element.type === "radio") {
                            ...
                            var $element = $(element);
                            $element.parents('form.js-ajax-form').find('.error-info').remove();
                            $element.parents('form.js-ajax-form').find('[type="submit"]').after(
                                '<span class="error-info" style="color:red">有文件未上传</span>');
                        } else {
                            var $element = $(element);
                    ...
                    submitHandler: function (form) {
                        ...
                        $form.ajaxSubmit({
                            ...
                            success: function (data, statusText, xhr, $form) {
                                ...
                                //按钮文案、状态修改
                                $btn.removeClass('disabled').prop('disabled', false).text(text.replace('...', '')).parent().find('span.error-info').remove();
